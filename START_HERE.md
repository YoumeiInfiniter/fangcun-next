...
本仓库由未改动的旧版 Fangcun 隔离副本建立，已经加入新版完整设计规格和真实问题调研材料。

当前只是新版开发起点：

- 旧代码尚未按新版规格重构；
- `SKILL.md`、`skills/`、`agents/` 和 `tools/` 主要反映旧版行为；
- 不得把“旧流程能运行”理解为“新版目标已经实现”；
- 不得直接接入生产 OpenClaw 或执行真实飞书操作。
...
5. 在修改代码前给出分阶段实施计划和第一阶段文件清单；
6. 从规格书 P0 开始，不提前堆叠飞书、Token 统计或主 Bot 管理功能。
